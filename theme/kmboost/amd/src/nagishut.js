define(['jquery'], function($) {
    ...
    $(document).ready(function() {
        ...
        $("#NagishLiLogo").hide();
        $("#NagishLiLogo").attr("src",'/theme/kmboost/pix/nagishut-icon.svg');
        $("#NagishLiLogo").show();
    ...
    * nagishli#NagishLiTag * {
    ...
    nagishli#NagishLiTag > #NagishLiBar > #NagishLiBarStrip {
      padding: 5px !important;   font-size:0px !important; background:#ffffff !important; box-shadow: 0 1px 0 #00667e inset, 0 -1px 0 #00667e inset !important; box-shadow: none !important;
    }
