...
$string['login_by_name_password'] = 'היכנס לפי שם וסיסמה';
$string['oauth2google'] = 'כתובת דוא”ל';
$string['unified_identification'] = 'הזדהות אחידה';
$string['frontpagehtmlblock'] = 'Front page HTML block';
$string['frontpagehtmlblock_desc'] = 'Put here code for html block';

//footer
$string['all_rights_reserved_Kadima_Mada'] = 'כל הזכויות שמורות לקדימה מדע, World ORT 2018';
$string['having_trouble_with_your_site'] = 'נתקלתם בבעיה כלשהי באתר?';
$string['contactus'] = 'מוזמנים ליצור איתנו קשר או למלא את הפרטים ואנו נחזור אליכם בהקדם';
$string['fullname'] = 'שם מלא';
$string['request_subject'] = 'נושא הפניה';
