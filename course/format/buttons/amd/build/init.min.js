...
initSlider($('.slider.sections'));sectionsEvents();$('.slider.sections .nav-item[data-section="'+currentSection+'"]').toggleClass('active');$('#section'+currentSection).toggleClass('d-none');$('.slider.sections').slick('slickGoTo',$('.slider.sections .slick-slide:has(.nav-item[data-section="'+currentSection+'"])')[0].dataset.slickIndex);initSlider($('#section'+currentSection+' .slider.labels'),0);labelsEvents(currentSection);initPrevNextBtns(currentSection);initPrevNextBtnsEvents();tooltipEvents();xsSectionArrowsEvents();}
...
var slide=this.parentNode.parentNode;if(slide.parentNode.childNodes.length>5&&slide.parentNode.childNodes.length-slide.dataset.slickIndex<4){var track=this.parentNode.parentNode.parentNode;var trackOffsetBottom=track.offsetTop+track.offsetHeight;var listOffsetBottom=track.parentNode.offsetTop+track.parentNode.offsetHeight;var float=trackOffsetBottom-listOffsetBottom;setTimeout(function(){track.style.transform='translate3d(0px,'+-float+'px,0px)';track.style.transition='translate 500ms ease 0s';},800);}});}
...
function initSlider(elem,vert){var dir,resp=[],brakepoints=[1200,992,768],brp,slides,focus;(document.dir=="rtl")?dir=true:dir=false;if(vert!==undefined){vert=true;dir=false;focus=true}else{vert=false;focus=false}
