...
initSlider($('.slider.sections'));sectionsEvents();$('.slider.sections .nav-item[data-section="'+currentSection+'"]').toggleClass('active');$('#section'+currentSection).toggleClass('d-none');currentIndex=parseInt($('.slider.sections .slick-slide:has(.nav-item[data-section="'+currentSection+'"])')[0].dataset.slickIndex);$('.slider.sections').slick('slickGoTo',currentIndex);initSlider($('#section'+currentSection+' .slider.labels'),0);labelsEvents(currentSection);initPrevNextBtns(currentSection);initPrevNextBtnsEvents();tooltipEvents();xsSectionArrowsEvents();}
