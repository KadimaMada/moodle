...
M.format_kmbuttons = M.format_kmbuttons || {
    ourYUI: null,
    numsections: 0
};

M.format_kmbuttons.init = function(Y, numsections) {
    this.ourYUI = Y;
    this.numsections = parseInt(numsections);
    document.getElementById('buttonsectioncontainer').style.display = 'table';
};

M.format_kmbuttons.hide = function() {
...
M.format_kmbuttons.show = function(id, courseid) {
    this.hide();
    ...
    M.format_kmbuttons.h5p();
};

M.format_kmbuttons.h5p = function() {
